                        ...
                        if (isset($_POST["search_button"])) 
                            {
                                ...
                                if (empty($search)) {
                                    ...
                                    $sql= mysqli_query($connect,"select * from tbl_sanpham where sanpham_name like '%$search%'");
                        ...
                        <div class="men-pro-item simpleCart_shelfItem">
                           ...
                           <div class="item-info-product text-center border-top mt-4">
                              ...
                              <div class="info-product-price my-2">
                                 <span class="item_price"><?php echo number_format($row_sanpham['sanpham_giakm']).'vnđ' ?></span>
