               ...
               <table class="listSanPham">
                  <tbody class="text-center">
                     ...
                     <tr>
                        ...
                        <td class="soluong">
                           <div class="number">
                              ...
                              <input class="clinput" type="text" data-id="<?php echo $row_lay_giohang['sanpham_id'] ?>" name="num_order" id="num_order[]" value="<?php echo $row_lay_giohang['soluong']?>" disabled/>
                        ...
                        <td>
                           ...
                           <span id="price" name="price"> <?php echo $row_lay_giohang['sanpham_giakm']?></span>vnđ
                        </td>
                        <td><span id="subtotal"></span>vnđ</td>
                        <td class="noPadding">
                     ...
                     <?php
                        ...
                        ?>
                     <tr>
                        <td class="text-center" style="font-weight:bold;font-size:20px" colspan="6">
                           Tổng Tiền Cần Thanh Toán: <span class="text-danger" id="total"></span>vnđ
                        </td>
                     </tr>
                     <tr>
                        ...
                        <td colspan="1">
                           ...
                           <i class="fas fa-usd"></i></i> $ THANH TOÁN
                           </a>
                        </td>
                     </tr>
                  </tbody>
