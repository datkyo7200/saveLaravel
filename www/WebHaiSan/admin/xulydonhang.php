...
<?php 
   // tru kho
   $sql_select_soluong = mysqli_query($connect,"SELECT sanpham_soluong FROM tbl_product where sanpham_soluong > 0");
   ...
   $soluongtru =0;
   if($tinhtrangdon>2 && $soluongtrongkho && isset($_POST['capnhatdonhang'])){
   $idsp = $_POST["idsp"];
