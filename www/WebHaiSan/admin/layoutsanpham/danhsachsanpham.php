    <?php
				...
				<div class="col-3" style="margin-left:5px">
					...
					<form action="" method="POST" enctype="multipart/form-data">
						...
						<label>Tóm tắt</label>
						<textarea class="form-control" name="chitiet" id="post_content" rows="10" cols="150"><?php echo $row_capnhat["sanpham_tomtat"] ?></textarea></br>
						<label>Mô tả</label>
						<textarea class="form-control" name="mota" id="post_content" rows="10" cols="150"><?php echo $row_capnhat["sanpham_mota"] ?></textarea></br>
