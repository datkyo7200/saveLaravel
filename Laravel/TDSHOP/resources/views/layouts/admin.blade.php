...
<body>
    <div id="warpper" class="nav-fixed">
        <nav class="topnav shadow navbar-light bg-white d-flex">
            <div class="navbar-brand"><a href="?">TDSHOP ADMIN</a></div>
            <div class="nav-right ">
                ...
                <div class="btn-group">
                    ...
                    <div class="dropdown-menu dropdown-menu-right">
                        ...
                        <a class="dropdown-item" href="{{ route('admin.logout') }}">Đăng xuất
                        </a>
                    </div>
                </div>
            </div>
                ...
                <ul id="sidebar-menu">
                    ...
                    <li class="nav-link">
                        ...
                        <ul class="sub-menu">
                            ...
                            <li><a href="{{url('admin/order/list')}}">Xem đơn hàng</a></li>
                        </ul>
                    </li>
